...
Security fixes target the current default branch (`main`) and the latest supported release line. Older snapshots may receive fixes only when explicitly announced.
